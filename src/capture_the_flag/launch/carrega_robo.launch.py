...
def generate_launch_description():
    ...
    # localizado na pasta `description` do pacote `capture_the_flag`.
    urdf_path = PathJoinSubstitution([
        FindPackageShare("capture_the_flag"),         # Diretório do pacote `capture_the_flag`
    ...
    diff_drive_params = PathJoinSubstitution([
        FindPackageShare("capture_the_flag"),
        "config",
    ...
    # ------------------------------------------------------
    # Carrega o arquivo de configuração do RViz a partir do pacote `capture_the_flag`.
