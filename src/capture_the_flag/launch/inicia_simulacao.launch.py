...
def generate_launch_description():
    ...
    # Encontra o diretório de instalação do pacote 'capture_the_flag'.
    pkg_share = FindPackageShare("capture_the_flag").find("capture_the_flag")
...
#    world_path='/usr/share/ignition/ignition-gazebo6/worlds/rolling_shapes.sdf'
    ...
    # Inicia o Gazebo Harmonic (Jazzy) com nível de log definido.
